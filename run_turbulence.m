...
switch a0
    case 'Model-free'
        ...
        out_Dir=[metadata.currentFolder '/TTB_results/' metadata.saveFile date]; % the direction of the bars depends on Win o Lin
        mkdir (out_Dir);
    ...
    case 'Model-based'
        ...
        a1 = questdlg('Did you already compute model-based appoach?', ...
            'The Turbulent Brain', ...
            'Yes','No','No thank you');
